...
@php
    $bulan = date("F");
    $pengeluaran_month = App\Models\Pengeluaran::where('bulan',$bulan)->sum('jumlah_pengeluaran');
@endphp
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Pengeluaran Bulan ini</h4>
                                        <h4 style="color: black; font-size: 30px;">Rp.{{ $pengeluaran_month }}</h4>
