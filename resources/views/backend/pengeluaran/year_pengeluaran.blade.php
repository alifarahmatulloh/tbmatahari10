...
@php
    $tahun = date("Y");
    $pengeluaran_year = App\Models\Pengeluaran::where('tahun',$tahun)->sum('jumlah_pengeluaran');
@endphp
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Pengeluaran Tahun ini</h4>
                                        <h4 style="color: black; font-size: 30px;">Rp.{{ $pengeluaran_year }}</h4>
