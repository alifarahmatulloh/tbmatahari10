                                ...
                                <div class="card">
                                    <div class="card-body">
                                            <div class="tab-pane" id="settings">
                                                <form id="myForm" method="post" action="{{ route('pengeluaran.store') }}" enctype="multipart/form-data">
                                                    @csrf

                                                    <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i>Tambah Pengeluaran</h5>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group mb-3">
                                                                <label for="name" class="form-label">Nama Pengeluaran</label>
                                                                <textarea id="example-textarea" name="nama_pengeluaran" class="form-control" rows="3" value="{{ old('nama_pengeluaran') }}"></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="jumlah_pengeluaran" class="form-control" value="{{ old('jumlah_pengeluaran') }}">
                                                            </div>
                                                        </div>
                ...
                <script type="text/javascript">
                    $(document).ready(function (){
                        $('#myForm').validate({
                            ...
                            messages :{
                                nama_pengeluaran: {
                                    required : 'Kolom nama pengeluaran wajib diisi',
                                }, 
                                jumlah_pengeluaran: {
                                    required : 'Kolom jumlah pengeluaran wajib diisi',
                                },
